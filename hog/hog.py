...
def pig_pass(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4b
    if opponent_score - player_score in [1, 2]:
        return True
    else:
        return False
    # END PROBLEM 4b
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            cur_score = take_turn(strategy0(score0, score1), score1, dice)
            score0_list.append(cur_score)
            score0 = sum(score0_list)
            if extra_turn(score0, score1) is False:
                who = other(who)
        elif who == 1:
            cur_score = take_turn(strategy1(score1, score0), score0, dice)
            score1_list.append(cur_score)
            score1 = sum(score1_list)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def print_highest(score0, score1):
        if who == 0:
            ...
            cur_score = score1
        inc_score = cur_score - last_score
        if inc_score > running_high:
            print(inc_score, 'point(s)! The most yet for Player', who)
        else:
            inc_score = running_high
        return announce_highest(who, cur_score, inc_score)
